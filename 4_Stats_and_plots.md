...
- [Visualization of statistics from
  ...
  - [Orthogroups - species overlap](#orthogroups---species-overlap)
  - [Orthologues statistics](#orthologues-statistics)
  - [Statistics per species](#statistics-per-species)
- [Histograms of protein length](#histograms-of-protein-length)
- [Statistics of supplementation of
  orthologues](#statistics-of-supplementation-of-orthologues)
...
obtaining additional statistics about inference of orthology,
supplementing orthologues with other homologues and functional
annotation. Some plots and statistics are already exported within the
previous RMarkdown files.
...
Histograms of protein length for all species. For the species annotated
by me, I have also histograms of protein length for different categories
of protein reliability. They are documented in
[3_Functional_annotations.md](3_Functional_annotations.md#adding-reliability-table-for-species-annotated-by-me).

Spectrum of protein lengths seems to nicely show an overprediction of
short genes in some species. The higher-quality annotations usually
don’t have such a high peak in the range of short proteins. That is
nicely shown by histograms of protein length for different categories of
protein reliability - when we filter for higher reliability, the
spectrum becomes very similar for all of the species.
...
The statistics of supplementation of orthologues is documented in
[2_Supplementing_orthologues.md](2_Supplementing_orthologues.md#big-loop).
