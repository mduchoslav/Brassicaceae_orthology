...
## heatmap with values
pdf ("figs/Orthogroups_SpeciesOverlaps_heatmap.pdf", width=14, height=7, onefile = T)
...
pdf ("figs/Comparative_Genomics_Statistics_heatmaps.pdf", width=14, height=7, onefile = T)
par(mar = c(2, 12, 12, 2) + 0.1)
for(i in 5:1) {
...
## heatmap with values
pdf ("figs/Statistics_PerSpecies_heatmap.pdf", width=16, height=7, onefile = T)
