...
# Example loop
for (i in 1:5) {
  # Create a log file for each iteration
  log_filename <- paste0("log_iteration_", i, ".txt")
  
  # Redirect output to the log file
  sink(log_filename)
  # Redirect warnings to the same log file
  sink(log_filename, type = "message")
  
  # Print some output (this will go to the log file)
  print(paste("This is iteration", i))
  
  # Generate a warning for demonstration (this will also go to the log file)
  if (i %% 2 == 0) {
    warning("This is a warning!")
  }
  
  # More output can be printed here
  print(paste("Random number:", runif(1)))
  
  # Stop redirecting output (this will stop saving the output to the log file)
  sink()
  sink(type = "message")
}
