...
This script supplements the list of orthologues from Orthofinder (brassicaceae_2) with results from BLAST and other tools.

# Enriching with BLAST

Approach similar to https://github.com/Sian-Bray/Cochlearia_2024
...
# Enriching list of orthologues from orthogroups
